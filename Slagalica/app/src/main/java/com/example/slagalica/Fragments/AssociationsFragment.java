 ...
 * Use the {@link AssociationsFragment#newInstance} factory method to
...
public class AssociationsFragment extends Fragment {
     ...
     * @return A new instance of fragment AssociationsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AssociationsFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        guessFinalSolutionButton.setOnClickListener(v -> {
            requireActivity()
                    .getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragmentContainer, new GuessTheCombinationFragment())
                    .commit();
        });
